...
import { DepertmentStyles, SearchStyles } from './Singlebrand.Styles.jsx'
...
import { colors } from './Singlebrand.Styles.jsx'
import { filterMenuStyles } from './Singlebrand.Styles.jsx'
...
// ==========================Hook===========================================
const useFetchProductsByBrandId = (brandId, query) => {
  ...
  useEffect(() => {
    if (brandId) {
      params.set('subSubCategory', brandId)
      params.set('limit', 24)
...
export const SingleBrandPage = () => {
  ...
  }, [categoryAndSubProducts, categAndSubProductsLoading, query, brandId])
    ...
    <>
      ...
      >
        ...
        <Typography
          ...
          onClick={() => navigate('/subSubCategories')}
        >
          {lng === 'en'
