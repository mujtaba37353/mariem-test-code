...
import { DepertmentStyles } from './Brands.style.js'
import { CiSearch } from 'react-icons/ci'
import Breadcrumbs from '../../../components/BreadCrumbs/BreadCrumbs.jsx'
import { useGetAllProductsOfBrandsQuery } from '../../../redux/apis/ProductApis.js'
  ...
  return (
    <>
      ...
      >
        ...
        >
          {lng === 'en' ? 'All sub sub categories' : 'الأقسام الفرعية الفرعية'}
        </Typography>
      </Stack>
      <Box sx={styles.Box}>
        <Box
                  ...
                  <Typography
                    ...
                    onClick={() =>
                      nav(
                        `/brands/${
                          item.brand._id
                        }/${item?.brand.name_en.replace(/\s/g, '')}`
                      )
                    }
                  >
                    {item.brand[`name_${lng === 'en' ? 'en' : 'ar'}`]}
                  </Typography>
                  {
                    <Stack
                      direction={'column'}
